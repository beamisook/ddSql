...
public class ProdVO {
	...
	public String getProd_outlinse() {
		return prod_outlinse;
	}
	public void setProd_outlinse(String prod_outlinse) {
		this.prod_outlinse = prod_outlinse;
	}
